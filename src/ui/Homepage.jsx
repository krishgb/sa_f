...
export default function Homepage() {
    const { global_allowed_routes, global_is_college } = useGlobalContext()
    return (
        ...
        <div>
            {
                ...
                <ForCollege clg={global_is_college} />
            }
        </div>
    )
}
...
function ForCollege({clg}) {

    return (
        <Grid color='black' w='90%' m='auto' gap={16}>
            {
                clg && 
                <>
                    <GridItem gap={2} display={'grid'}>
                        <Heading borderBottom={'3px solid #000'} pb={2} as='h4' fontSize={'1.3rem'} color={'twitter.900'}>Name Change</Heading>
                        <Grid gap={4} ml={8}>
                            ...
                            <OrderedList display={'grid'} gap={3} paddingLeft={'2rem'}>
                            ...
                            <p><Link as={NavLink} to="/name_change/new_or_check_status" color={'blue'} fontWeight='bold' textDecoration={'underline'}>Click here</Link> for Name Change updation and to check status of your Name Change application</p>
                        </Grid>

                    </GridItem>

                    <GridItem gap={2} display={'grid'}>
                        <Heading borderBottom={'3px solid #000'} pb={2} as='h4' fontSize={'1.3rem'} color={'twitter.900'}>Break of Study</Heading>
                        <Grid gap={4} ml={8}>
                            ...
                            <p><Link as={NavLink} to="/break_of_study/new" color={'blue'} fontWeight='bold' textDecoration={'underline'}>Click here</Link> for Break of Study application and to check status of your Break of Study application</p>
                        </Grid>
                    </GridItem>
                </>
            }
            ...
            <GridItem gap={2} display={'grid'}>
                ...
                <Heading borderBottom={'3px solid #000'} pb={2} as='h4' fontSize={'1.3rem'} color={'twitter.900'}>Grievance</Heading>
                <Grid gap={4} ml={8}>
                    ...
                    <p>
                        <strong><u>Academic Grievances: </u></strong>
                    </p>

                    <UnorderedList display={'grid'} gap={3} paddingLeft={'2rem'}>
                    ...
                    <p>
                    <strong><u>Non Academic Grievances: </u></strong>
                    </p>
                    <UnorderedList display={'grid'} gap={3} paddingLeft={'2rem'}>
                    ...
                    <p><Link as={NavLink} to="/grievance/new_or_check_status" color={'blue'} fontWeight='bold' textDecoration={'underline'}>Click here</Link> for Grievance registration and to check status of your Grievance application</p>
                </Grid>
            </GridItem>
