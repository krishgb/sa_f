        ...
        >
            <Grid>
                <FormControl isRequired>
                    <Flex gap={6}>
                        ...
                        <RadioGroup 
                            size='sm' 
                            onChange={(e)=>{set_data('lack_of_attendance_break_of_study',e)}}
                            defaultValue={entries.lack_of_attendance_break_of_study}
                        >
                            <HStack>
...

                {
                    ...
                    <Input
                        ...
                        onChange={(e)=>{set_data('lack_of_attendance_break_of_study_sem',e.target.value)}}
                        defaultValue={entries.lack_of_attendance_break_of_study_sem}
                    />
                    <FormControl>
                        <FormLabel size='sm' fontSize={'14px'}>From</FormLabel>
                            <HStack>
                                <PinInput 
                                    otp size={'sm'} 
                                    placeholder="M" 
                                    onChange={(e)=>{set_data('lack_of_attendance_from_month',e)}}
                                    defaultValue={entries.lack_of_attendance_from_month}
                                >
                                ...
                                <PinInput 
                                    otp size={'sm'} 
                                    placeholder="Y" 
                                    onChange={(e)=>{set_data('lack_of_attendance_from_year',e)}}
                                    defaultValue={entries.lack_of_attendance_from_year}
                                >
                        ...
                        <FormLabel size='sm' fontSize={'14px'}>To</FormLabel>
                            <HStack>
                                <PinInput 
                                    otp size={'sm'} 
                                    placeholder="M" 
                                    onChange={(e)=>{set_data('lack_of_attendance_to_month',e)}}
                                    defaultValue={entries.lack_of_attendance_to_month}
                                >
                                    <PinInputField border='1px solid #cccccc50' placeholder="M" />
                                    <PinInputField border='1px solid #cccccc50' placeholder="M" />
                                </PinInput>
                                ...
                                <PinInput 
                                    otp size={'sm'} 
                                    placeholder="Y" 
                                    onChange={(e)=>{set_data('lack_of_attendance_to_year',e)}}
                                    defaultValue={entries.lack_of_attendance_to_year}
                                >
                                    <PinInputField size={'sm'} border='1px solid #cccccc50' placeholder="Y" />
                                    <PinInputField border='1px solid #cccccc50' placeholder="Y" />
                                    <PinInputField border='1px solid #cccccc50' placeholder="Y" />
            ...
            <FormControl size='sm'>
                ...
                <Textarea 
                    ...
                    fontSize='14px' 
                    border='1px solid #cccccc50' 
                    placeholder='Reason for Break of Study' 
                    onChange={(e)=>{set_data('reason',e.target.value)}}
                    defaultValue={entries.reason}
                />
            </FormControl>
                ...
                <Grid templateColumns={'1fr 1fr'} gap={6}>
                    <FormControl isRequired>
                        ...
                        <Input 
                            ...
                            placeholder='Door no.' 
                            onChange={(e)=>{set_data('door_no',e.target.value)}}
                            defaultValue={entries.door_no}
                        />
                    </FormControl>
                    ...
                    <FormControl isRequired>
                        ...
                        <Input 
                            ...
                            size='sm' fontSize={'14px'} 
                            placeholder='Street' 
                            onChange={(e)=>{set_data('street',e.target.value)}}
                            defaultValue={entries.street}
                        />
                    </FormControl>
                    ...
                    <FormControl isRequired>
                        ...
                        <Input 
                            ...
                            size='sm' fontSize={'14px'} 
                            placeholder='City' 
                            onChange={(e)=>{set_data('city',e.target.value)}}
                            defaultValue={entries.city}
                        />
                    </FormControl>
                    ...
                    <FormControl isRequired>
                        ...
                        <Input 
                            ...
                            size='sm' fontSize={'14px'} 
                            placeholder='State' 
                            onChange={(e)=>{set_data('state',e.target.value)}}
                            defaultValue={entries.state}
                        />
                    </FormControl>
                        ...
                        <div>
                            ...
                            <HStack>
                                <PinInput 
                                    size='sm' 
                                    otp 
                                    onChange={(e)=>{set_data('pincode',e)}}
                                    defaultValue={entries.pincode}
                                >
